...
const subjects = [
  { id: 1, subject: "Экономика отрасли", teacher_id: 1 },
  { id: 2, subject: "Экономика организации", teacher_id: 1 },
  { id: 3, subject: "Основы экономики", teacher_id: 1 },
  { id: 4, subject: "Экономика и управление", teacher_id: 1 },
  { id: 5, subject: "Перспективы развития РФ", teacher_id: 1 },

  { id: 6, subject: "ТРПО", teacher_id: 2 },
  { id: 7, subject: "Математическое моделирование", teacher_id: 2 },
  { id: 8, subject: "Осуществление интеграция ПМ", teacher_id: 2 },

  { id: 9, subject: "Эксплуатация объектов", teacher_id: 3 },
  { id: 10, subject: "Практика учебная", teacher_id: 3 },
  { id: 11, subject: "Обеспечение качества КС", teacher_id: 3 },
  { id: 12, subject: "Операционные системы и среды", teacher_id: 3 },

  { id: 13, subject: "РПМ", teacher_id: 4 },
  { id: 14, subject: "Практика учебная", teacher_id: 4 },
  { id: 15, subject: "Системное программирование", teacher_id: 4 },
  { id: 16, subject: "Оператор ЭВМ", teacher_id: 4 },

  { id: 17, subject: "Основы алгоритм. и програм.", teacher_id: 5 },
  { id: 18, subject: "ППО в проф. деятельности", teacher_id: 5 },
  { id: 19, subject: "Инстрементальные средства РПО", teacher_id: 5 },
  
  { id: 20, subject: "РПМ", teacher_id: 6 },
  { id: 21, subject: "Проектир. веб-приложений", teacher_id: 6 },
  { id: 22, subject: "ТР и ЗБД", teacher_id: 6 },
  { id: 23, subject: "РиП графических материалов", teacher_id: 6 },
  { id: 24, subject: "Основы ПиР веб-приложений", teacher_id: 6 },
  { id: 25, subject: "Практика учебная", teacher_id: 6 },
  { id: 26, subject: "Разработка дизайна", teacher_id: 6 },
  { id: 27, subject: "Основых информационных технологий", teacher_id: 6 },

  { id: 28, subject: "Финансовая грамотность", teacher_id: 7 },
  { id: 29, subject: "Основы финанс. грам.", teacher_id: 7 },
  { id: 30, subject: "Менеджмент", teacher_id: 7 },
  { id: 31, subject: "Экономика отрасли", teacher_id: 7 },
  { id: 32, subject: "Основы бережливого произ.", teacher_id: 7 },

  { id: 33, subject: "Физическая культура", teacher_id: 8 },

  { id: 34, subject: "Основы программирования в 1С", teacher_id: 9 },
  { id: 35, subject: "Комплексная автоматизация", teacher_id: 9 },
  { id: 36, subject: "Внедрение и поддержка КС", teacher_id: 9 },
  { id: 37, subject: "Обмен данными", teacher_id: 9 },
  { id: 38, subject: "Поддержка и тестирование ПМ", teacher_id: 9 },
  { id: 39, subject: "ТР и ЗБД", teacher_id: 9 },

  { id: 40, subject: "Иностранный язык", teacher_id: 10 },
  { id: 41, subject: "Иностранный язык в проф. деят.", teacher_id: 10 },
];
